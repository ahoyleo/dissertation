...
\end{tabular}
\end{center}
\caption[The RDF bipartite graph for the combined representation of both the data and the ontology]{\label{fig:hypergraph-combined} The RDF bipartite graph representation (A) given triples shown in (B) based on the information described in Figure~\ref{fig:onto-and-data}.}
\end{figure}
