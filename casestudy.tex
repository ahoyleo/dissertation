This chapter presents case studies that provide detailed descriptions to applications of the proposed graph-based semantic data mining method. Experiments are conducted in each case study to illustrate the utility and performance of different components of the method. Our intent was to report both challenges and benefits of the method in each case study in order to provide a realistic evaluation.
